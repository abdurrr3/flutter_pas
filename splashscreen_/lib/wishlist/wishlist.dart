...
import 'package:splashscreen_/wishlist/component.dart';
...
class _WishListState extends State<WishList> {
  ...
  static List<WishList_model> list_wishList = [
    WishList_model(0,'wishlist/lemari.png','ALEX','Unit laci, abu-abu toska, \n 36x70 cm','Rp1.350.000'),
    WishList_model(1,'wishlist/kursi.png', 'MILLBERGET', 'Kursi putar, murum hitam', 'Rp1.799.000'),
    WishList_model(2,'wishlist/kasur.png', 'SONGESAND', 'Rngk tmpt tdr dg 2 ktk penyimpanan,  cokelat, 160x200 cm', 'Rp3.499.000'),
    WishList_model(3,'wishlist/lemari.png', 'HEKTAR', 'Lampu lantai, abu-abu tua', 'Rp1.299.000'),
  ];
